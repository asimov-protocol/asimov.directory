    ...
    <div className="text-white pt-0 py-6 divide-y divide-gray-700 sticky top-4">
      <div className="pb-3">
        ...
        <p className="text-xl font-bold mt-2">
          254 <span className="text-sm font-normal text-gray-400">Views</span>
        </p>
        <p className="text-xl font-bold">
          87{' '}
          <span className="text-sm font-normal text-gray-400">Downloads</span>
        </p>
      </div>
      ...
      <div className="py-3">
        ...
        <p className="text-gray-300">
          4,198,543 <span className="text-sm">Triples</span>
        </p>
        <p className="text-gray-300">
          59,999 <span className="text-sm">Nodes</span>
        </p>
        <p className="text-gray-300">
          249,999 <span className="text-sm">Edges</span>
        </p>
      </div>
