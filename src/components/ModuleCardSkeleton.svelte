<div class="overflow-hidden rounded-lg border border-sSlate-200 bg-white p-6 shadow-sm">
  ...
  <div class="mb-4 flex items-start justify-between">
    <div class="flex items-center space-x-3">
      ...
      <div>
        <div class="h-4 w-24 bg-gGray-100 rounded animate-pulse mb-1"></div>
  ...
  <div class="flex items-center justify-between">
    <div class="flex items-center space-x-4">
      <div class="h-3 w-16 bg-gGray-100 rounded animate-pulse"></div>
      <div class="h-3 w-8 bg-gGray-100 rounded animate-pulse"></div>
    </div>
    <div class="h-3 w-20 bg-gGray-100 rounded animate-pulse"></div>
  </div>
</div>
