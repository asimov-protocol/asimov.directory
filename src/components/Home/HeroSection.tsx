  ...
  <div className="flex flex-col lg:flex-row w-full h-(--hero-height) text-white">
    ...
    <div className="flex flex-col justify-center items-start w-full lg:w-1/2 space-y-6">
      ...
      <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
        Unbiased AI starts with <span className="text-oOrange-500">unbiased data</span>
      </h1>
      ...
      <div className="flex space-x-4">
        <Link href="/datasets" className="bg-white text-black rounded-xl transition-colors hover:bg-gray-200 px-6 py-3 text-lg font-medium">
          Explore datasets
        </Link>
        <Link href="#" className="text-white hover:underline px-6 py-3 text-lg font-medium">
          Learn more
        </Link>
      </div>
    </div>
